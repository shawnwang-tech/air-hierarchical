...
class MT_GC_GRU(nn.Module):
    def __init__(self, gpu_id, in_dim, out_dim, hid_dim, gnn_out_dim, batch_size, use_met, use_time, hist_len, pred_len, sta_num, city_num, adj_sta, interval_set, k_hop, norm):
        super(MT_GC_GRU, self).__init__()
