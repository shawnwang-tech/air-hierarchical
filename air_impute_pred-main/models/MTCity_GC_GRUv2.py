...
class MTCity_GC_GRUv2(nn.Module):
    def __init__(self, gpu_id, in_dim, out_dim, hid_dim, batch_size, use_met, use_time, hist_len, pred_len, sta_num, city_num, adj_sta, adj_city, afc_s2c, interval_set):
        super(MTCity_GC_GRUv2, self).__init__()
    ...
    def forward(self, model_input):
        ...
        for t in range(self.hist_len - 1):
            ...
            hcn = self.gru_cell(xc_gru, hcn, idx)
