...
class City_GC_GRU(nn.Module):
    def __init__(self, gpu_id, in_dim, out_dim, hid_dim, gnn_out_dim, batch_size, use_met, use_time, hist_len, pred_len, sta_num, city_num, adj_sta, adj_city, afc_s2c, k_hop, norm):
        super(City_GC_GRU, self).__init__()
    ...
    def forward(self, model_input):
        ...
        for t in range(1, self.hist_len):
            ...
            hcn = self.c_gru_cell(xc_gru, hcn)
