...
class GC_LSTM(nn.Module):
    def __init__(self, gpu_id, in_dim, out_dim, hid_dim, batch_size, use_met, use_time, hist_len, pred_len, sta_num, city_num, adj_sta, k_hop):
        ...
        self.rnn_cell = nn.LSTM()(self.in_dim + self.gcn_out, self.hid_dim)
