...
class PM25GNN(nn.Module):
    def __init__(self, gpu_id, hist_len, pred_len, in_dim, out_dim, hid_dim, gnn_out_dim, node_num, batch_size, edge_index, edge_attr, wind_mean, wind_std, use_met, use_time):
